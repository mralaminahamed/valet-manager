# ⚠ Use the live Claude Design file — not this document alone

> **Paste this command into Claude (not Claude Code):**
>
> ```
...
> ```
>
> The HTML file at that URL is the canonical design. This markdown document is the
> offline fallback spec — sections D1–D10 below describe the same content in text form.
